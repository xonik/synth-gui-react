...
export const lcscParts = [
    ...
    '250k,R,R0805,C5156563,0,E',
    '270k,R,R0805,C17589,0,E',
    '270k,R,R0603,C22965,0,E',
    '270k,R,R0402,C25770,0,E',
    ...
    '500k,R,R0603,C2902631,0,E',
    '510k,R,R0603,C23192,0,B',
    ...
    'DG413-JT,O,TSSOP16,C3656939,0,E',
    ...
    'MMBT3904,O,SOT23-BEC,C20526,90,B',
    ...
    '6N137-JSD,O,SMD-8-J,C22375543,0,E',
    ...
    'WJ300V-5.0-3P,O,WJ300V-5.0-3P,C8483,180,E',
    '25k,O,RTRIM3296X_J,C111789,180,E',
    '500R,R,RTRIM3296X,C118913,0,E',
    'CHIP-LED0603,O,CHIP-LED0603,C2286,90,B',
    'RED-C84256,O,CHIPLED_0805,C84256,90,B',
    'YELLOW-C2296,O,CHIPLED_0805,C2296,90,B',
    'GREEN-C2297,O,CHIPLED_0805,C2297,90,B',
...
export const multiParts: Record<string, MultiPart[]> = {
    'SVF-CELL-V1.1V': [
        { x: -17.78, y: 0, id: 'C2932672' },
        { x: 17.78, y: 0, id: 'C2932672' },
    ], // 7p
    'RM-NOISE-DIST-V1.1': [
        { x: 0, y: -7.62, id: 'C7499326' },
        { x: 0, y: 7.62, id: 'C7499326' },
    ], // 6p
    'VCO-V2.0': [
        { x: 0, y: -7.62, id: 'C7499326' },
    ...
    'BUS-MIXER-V1.3': [
        { x: -21.59, y: 0, id: 'C7499334' },
        { x: 21.59, y: 0, id: 'C7499334' },
    ], //16p
    'BITCRUSHER-V1.0': [
        { x: 0, y: -7.62, id: 'C25503120' },
        { x: 0, y: 7.62, id: 'C25503120' },
    ], //14p
    DAC8565F: [
        { x: 0, y: -3.81, id: 'C7499328' },
        { x: 0, y: 3.81, id: 'C7499328' },
    ], // 8p
    'RECON-FILTER-V1.1': [
        { x: 0, y: -3.81, id: 'C7499328' },
