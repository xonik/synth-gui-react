...
const filtersControllers: FiltersControllers = {
    LPF: {
        ...
        FM_AMT: {
            id: ControllerIdIntermediate.LPF_FM_AMT,
            isDstDigi: true,
            label: 'FM amount',
            shortLabel: 'FM amt',
            type: 'pot',
        ...
        ENV_AMT: {
            id: ControllerIdIntermediate.LPF_ENV_AMT,
            isDstDigi: true,
            label: 'Env amount',
            shortLabel: 'Env amt',
            type: 'pot',
        ...
        LFO_AMT: {
            id: ControllerIdIntermediate.LPF_LFO_AMT,
            isDstDigi: true,
            label: 'LFO amount',
            shortLabel: 'LFO amt',
            type: 'pot',
        ...
        KBD_AMT: {
            id: ControllerIdIntermediate.LPF_KBD_AMT,
            isDstDigi: true,
        ...
        WHEEL_AMT: {
            id: ControllerIdIntermediate.LPF_WHEEL_AMT,
            label: 'Wheel amount',
            shortLabel: 'Wheel amt',
            isDstDigi: true,
            type: 'pot',
            addr: NRPN.LPF_WHEEL_AMT,
        },
        EXT_CV: {
    ...
    SVF: {
        ...
        FM_AMT: {
            id: ControllerIdIntermediate.SVF_FM_AMT,
            label: 'FM amount',
            shortLabel: 'FM amt',
            isDstDigi: true,
            type: 'pot',
        ...
        WHEEL_AMT: {
            id: ControllerIdIntermediate.SVF_WHEEL_AMT,
            label: 'Wheel amount',
            shortLabel: 'Wheel amt',
            isDstDigi: true,
            type: 'pot',
            addr: NRPN.SVF_WHEEL_AMT,
        },
        ENV_AMT: {
            id: ControllerIdIntermediate.SVF_ENV_AMT,
            label: 'Env amount',
            shortLabel: 'Env amt',
            isDstDigi: true,
            type: 'pot',
        ...
        LFO_AMT: {
            id: ControllerIdIntermediate.SVF_LFO_AMT,
            label: 'LFO amount',
            shortLabel: 'LFO amt',
            isDstDigi: true,
            type: 'pot',
        ...
        KBD_AMT: {
            id: ControllerIdIntermediate.SVF_KBD_AMT,
            label: 'Keyboard track',
            shortLabel: 'Kbd trk',
            isDstDigi: true,
            type: 'pot',
