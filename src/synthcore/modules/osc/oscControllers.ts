...
const oscControllers: OscControllers = {
    DCO1: {
        ...
        MODE: { id: ControllerIdNonMod.DCO1_MODE, label: 'Mode', type: 'button', values: [buttonMidiValues.OSC1_MODE_DCO, buttonMidiValues.OSC1_MODE_WT], valueLabels: ['DCO', 'WT'] },
    ...
    DCO2: {
        ...
        MODE: { id: ControllerIdNonMod.DCO2_MODE, label: 'Mode', type: 'button', values: [buttonMidiValues.OSC2_MODE_DCO, buttonMidiValues.OSC2_MODE_WT], valueLabels: ['DCO', 'WT'] },
