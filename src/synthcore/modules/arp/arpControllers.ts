...
const arpControllers: ArpControllers = {
    ...
    ON_OFF: {
        ...
        values: [
            BUTTONS.BUTTONS_CENTER.values.ARP_OFF,
            BUTTONS.BUTTONS_CENTER.values.ARP_ON,
        ],
    },
    TRIGGER: {
        ...
        cc: BUTTONS.BUTTONS_CENTER.cc,
        values: [
            BUTTONS.BUTTONS_CENTER.values.ARP_TRIGGER_OFF,
            BUTTONS.BUTTONS_CENTER.values.ARP_TRIGGER_ON,
        ],
    },
    SYNC: {
        ...
        cc: BUTTONS.BUTTONS_CENTER.cc,
        values: [
            BUTTONS.BUTTONS_CENTER.values.ARP_SYNC_OFF,
            BUTTONS.BUTTONS_CENTER.values.ARP_SYNC_MASTER,
            BUTTONS.BUTTONS_CENTER.values.ARP_SYNC_LFO1,
            BUTTONS.BUTTONS_CENTER.values.ARP_SYNC_EXT,
        ],
    },
    RANGE: {
        ...
        cc: BUTTONS.BUTTONS_CENTER.cc,
        values: [
            BUTTONS.BUTTONS_CENTER.values.ARP_RANGE_1,
            BUTTONS.BUTTONS_CENTER.values.ARP_RANGE_2,
            BUTTONS.BUTTONS_CENTER.values.ARP_RANGE_3,
        ],
    },
    MODE: {
        ...
        cc: BUTTONS.BUTTONS_CENTER.cc,
        values: [
            BUTTONS.BUTTONS_CENTER.values.ARP_MODE_UP,
            BUTTONS.BUTTONS_CENTER.values.ARP_MODE_DOWN,
            BUTTONS.BUTTONS_CENTER.values.ARP_MODE_UP_DOWN,
            BUTTONS.BUTTONS_CENTER.values.ARP_MODE_RANDOM,
            BUTTONS.BUTTONS_CENTER.values.ARP_MODE_OTHER,
        ],
    },
