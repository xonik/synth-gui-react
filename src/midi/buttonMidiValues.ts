export enum buttonMidiValues {
    ...
    OSC1_DAC_16BIT,
    OSC1_DAC_12BIT,
    OSC1_MORPH_MODE_CONTINUOUS,
    OSC1_MORPH_MODE_STEPPED,
    OSC1_MORPH_POINT_CONTINUOUS,
    OSC1_MORPH_POINT_PHASE_START,
    OSC1_SAMPLE_SELECT_INTERPOLATE,
    OSC1_SAMPLE_SELECT_NEAREST,
    ...
    OSC2_DAC_16BIT,
    OSC2_DAC_12BIT,
    OSC2_MORPH_MODE_CONTINUOUS,
    OSC2_MORPH_MODE_STEPPED,
    OSC2_MORPH_POINT_CONTINUOUS,
    OSC2_MORPH_POINT_PHASE_START,
    OSC2_SAMPLE_SELECT_INTERPOLATE,
    OSC2_SAMPLE_SELECT_NEAREST,
    ...
    ARP_FUZZY_START_OFF,
    ARP_FUZZY_START_ON,
    ARP_STOP_ON_RELEASE_OFF,
    ARP_STOP_ON_RELEASE_ON,
    ARP_RES_QUARTER,
    ARP_RES_QUARTER_TRIPLET,
    ARP_RES_8TH,
    ARP_RES_8TH_TRIPLET,
    ARP_RES_16TH,
    ARP_RES_16TH_TRIPLET,
    ARP_RES_32ND,
    ARP_RES_32ND_TRIPLET,
    ARP_RES_MAX,

    ARP_START_RES_QUARTER,
    ARP_START_RES_QUARTER_TRIPLET,
    ARP_START_RES_8TH,
    ARP_START_RES_8TH_TRIPLET,
    ARP_START_RES_16TH,
    ARP_START_RES_16TH_TRIPLET,
    ARP_START_RES_32ND,
    ARP_START_RES_32ND_TRIPLET,
    ARP_START_RES_MAX,
