...
import { jsToMidiEncoder, splitInt8To7, splitTo7 } from './serializer'
...
export function saveCvMappings(voice: number = VOICE_ALL) {
    const paramBytes: number[] = []
    const data = [...splitInt8To7(voice), ...splitTo7(FunctionNames.saveCvMappings, 14), ...paramBytes]
...
export function loadCvMappings(voice: number = VOICE_ALL) {
    const paramBytes: number[] = []
    const data = [...splitInt8To7(voice), ...splitTo7(FunctionNames.loadCvMappings, 14), ...paramBytes]
...
export function saveTrimmerSettings(voice: number = VOICE_ALL) {
    const paramBytes: number[] = []
    const data = [...splitInt8To7(voice), ...splitTo7(FunctionNames.saveTrimmerSettings, 14), ...paramBytes]
...
export function releaseCVOverrides(voice: number = VOICE_ALL) {
    const paramBytes: number[] = []
    const data = [...splitInt8To7(voice), ...splitTo7(FunctionNames.releaseCVOverrides, 14), ...paramBytes]
...
export function tuneVco(voice: number = VOICE_ALL) {
    const paramBytes: number[] = []
    const data = [...splitInt8To7(voice), ...splitTo7(FunctionNames.tuneVco, 14), ...paramBytes]
...
export function calibrateDCO1(voice: number = VOICE_ALL) {
    const paramBytes: number[] = []
    const data = [...splitInt8To7(voice), ...splitTo7(FunctionNames.calibrateDCO1, 14), ...paramBytes]
...
export function calibrateDCO2(voice: number = VOICE_ALL) {
    const paramBytes: number[] = []
    const data = [...splitInt8To7(voice), ...splitTo7(FunctionNames.calibrateDCO2, 14), ...paramBytes]
...
export function measureVcoOctaves(voice: number = VOICE_ALL) {
    const paramBytes: number[] = []
    const data = [...splitInt8To7(voice), ...splitTo7(FunctionNames.measureVcoOctaves, 14), ...paramBytes]
...
export function measureVcoAll(voice: number = VOICE_ALL) {
    const paramBytes: number[] = []
    const data = [...splitInt8To7(voice), ...splitTo7(FunctionNames.measureVcoAll, 14), ...paramBytes]
...
export function manualTuneVcoStart(voice: number = VOICE_ALL) {
    const paramBytes: number[] = []
    const data = [...splitInt8To7(voice), ...splitTo7(FunctionNames.manualTuneVcoStart, 14), ...paramBytes]
...
export function manualTuneVcoStop(voice: number = VOICE_ALL) {
    const paramBytes: number[] = []
    const data = [...splitInt8To7(voice), ...splitTo7(FunctionNames.manualTuneVcoStop, 14), ...paramBytes]
...
export function powerDown(voice: number = VOICE_ALL) {
    const paramBytes: number[] = []
    const data = [...splitInt8To7(voice), ...splitTo7(FunctionNames.powerDown, 14), ...paramBytes]
...
export function powerUp(voice: number = VOICE_ALL) {
    const paramBytes: number[] = []
    const data = [...splitInt8To7(voice), ...splitTo7(FunctionNames.powerUp, 14), ...paramBytes]
...
export function setCtrlAllParams(settings: number[], voice: number = VOICE_ALL) {
    const paramBytes: number[] = [...jsToMidiEncoder['std::vector<int16_t>'](settings)]
    const data = [...splitInt8To7(voice), ...splitTo7(FunctionNames.setCtrlAllParams, 14), ...paramBytes]
    logger.midi('RPC call to setCtrlAllParams')
    sendSysex(sysexCommands.RPC, data)
}

export function setCtrlAllNonModSettings(settings: number[], voice: number = VOICE_ALL) {
    const paramBytes: number[] = [...jsToMidiEncoder['std::vector<uint16_t>'](settings)]
    const data = [...splitInt8To7(voice), ...splitTo7(FunctionNames.setCtrlAllNonModSettings, 14), ...paramBytes]
...
export function setAllEnvModAmounts(
    env: number,
    offsetDst: number,
...
export function setAllLfoModAmounts(
    lfo: number,
    offsetDst: number,
    sourceAmounts: number[],
    voice: number = VOICE_ALL
