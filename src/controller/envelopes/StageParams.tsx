        ...
        <Params>
            {stages
                ...
                .map((stage) => {
                    ...
                    return (
                        <div className="stage-params__item" key={stage.id}>
                            <div
                                className={classNames('stage-params__item__value', {
                                    'stage-params__item__value--hidden': timeHidden,
                                })}
                            >
                            ...
                            <div
                                className={classNames('stage-params__item__value', {
                                    'stage-params__item__value--hidden': levelHidden,
                                })}
                            >
                                {formatLevel(stage)}
                            </div>
