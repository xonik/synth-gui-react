...
import mainDisplayApi, { getPotResolution } from '../../synthcore/modules/mainDisplay/mainDisplayApi'
...
const MainDisplay = React.forwardRef<SVGRectElement, Props>(({ x, y, height, width, panelHeight }, displayRef) => {
    ...
    const makeMenuClick = useCallback(
        (index: number) => () => {
    ...
    const makePotIncrement = useCallback(
        (potIndex: number) => (delta: number) => {
        ...
        <>
            ...
            {true && (
                <rect
                    x={x + BORDER_MARGIN}
                    y={y + 22}
                    height={height - BORDER_MARGIN - 75}
                    width={width - 2 * BORDER_MARGIN}
                    className="bezel"
                />
            )}
            <RoundPushButton8
                x={displayCenterX - 2.5 * buttonSpacing}
                y={buttonRow}
                radioButtonIndex={0}
                value={menuIndex}
            ...
            />
            <RoundPushButton8
                x={displayCenterX - 1.5 * buttonSpacing}
                y={buttonRow}
                radioButtonIndex={1}
                value={menuIndex}
            ...
            />
            <RoundPushButton8
                x={displayCenterX - 0.5 * buttonSpacing}
                y={buttonRow}
                radioButtonIndex={2}
                value={menuIndex}
            ...
            <RotaryPotWOLeds10
                x={displayCenterX - 2.5 * potSpacing}
                y={potRow}
                silver
            ...
            />
            <RotaryPotWOLeds10
                x={displayCenterX - 1.5 * potSpacing}
                y={potRow}
                silver
            ...
            />
            <RotaryPotWOLeds10
                x={displayCenterX - 0.5 * potSpacing}
                y={potRow}
                silver
